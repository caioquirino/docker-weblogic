...
update-alternatives --install /usr/bin/java java /usr/lib/jvm/jdk1.8.0_40/bin/java 100
update-alternatives --install /usr/bin/javac javac /usr/lib/jvm/jdk1.8.0_40/bin/javac 100
update-alternatives --set java /usr/lib/jvm/jdk1.8.0_40/bin/java
update-alternatives --set javac /usr/lib/jvm/jdk1.8.0_40/bin/javac
